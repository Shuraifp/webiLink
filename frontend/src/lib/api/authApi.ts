...
export const signup = async (username: string, email: string, password: string) => {
    try {
        const res = await apiWithoutAuth.post("/auth/signup", { username, email, password });
        return res.data;
    } catch (error) {
        throw error
    }
...
export const resendOtp = async (username: string, email: string, password: string) => {
    try {
        const res = await apiWithoutAuth.post("/auth/signup", { username, email, password });
        return res.data;
    } catch (error) {
...
export const logout = async () => {
    try {
        const res = await userApiWithAuth.post("/auth/logout")
        return res.data
    } catch (error) {
        throw error
    }
